...
{
    /// <summary>
    /// The Tuxedo.Contrib extensions for Tuxedo
    /// </summary>
...
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null, string[] propertiesToUpdate = null) where T : class
        {
        ...
        public static bool Update<T>(this IDbConnection connection, object keyValues, object updateValues, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            if (keyValues == null)
